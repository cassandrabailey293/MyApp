...
import { getEntities as getAs } from 'app/entities/MyApp/a/a.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.myAppB.home.createOrEditLabel">
            <Translate contentKey="myApp.myAppB.home.createOrEditLabel">Create or edit a B</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
