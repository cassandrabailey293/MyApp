...
export const B = (props: IBProps) => {
  ...
  return (
    <div>
      <h2 id="b-heading">
        <Translate contentKey="myApp.myAppB.home.title">BS</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="myApp.myAppB.home.createLabel">Create new B</Translate>
        </Link>
      </h2>
        ...
        {bList && bList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myApp.myAppB.a">A</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.myAppB.home.notFound">No BS found</Translate>
            </div>
          )
        )}
      </div>
